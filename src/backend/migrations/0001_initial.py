    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalles', models.ManyToManyField(related_name='tramites_rel', to='backend.activos_plaqueados')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ubicacion_anterior', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='no_plaqueados', to='backend.ubicaciones')),
            ],
            options={
